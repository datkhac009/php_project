...
if($_SERVER["REQUEST_METHOD"] == "GET") {
    if(isset($_GET["search"]) && !empty($_GET["search"])) {
        $result = search(addslashes($_GET["search"]));
        ...
        <div class="collapse navbar-collapse" id="collapse">
            ...
            <li class="nav-item">
                <form action="search.php" method="get" class="search-field">
                    <input type="text" name="search" placeholder="Search Anything..." class="input-type" value="<?php echo htmlspecialchars($_GET["search"], ENT_QUOTES); ?>">
    ...
    <div class="container">
        <div class="row">
            <?php if($search_count !== 0): ?>
                ...
                <?php endfor; ?>
            <?php else: ?>
            <!-- <img src="https://cdn.dribbble.com/users/760295/screenshots/4433975/no-search-result.png?compress=1&resize=800x600" alt="no result found" class="no-result"> -->
            <p class="no-result col-sm-12">No Result Found</p>
            <?php endif; ?>
        </div>
    </div>
    <!-- product end -->
